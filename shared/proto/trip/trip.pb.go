...
type UpdateFareSeatsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *UpdateFareSeatsRequest) Reset() {
	*x = UpdateFareSeatsRequest{}
	mi := &file_trip_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateFareSeatsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateFareSeatsRequest) ProtoMessage() {}

func (x *UpdateFareSeatsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_trip_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateFareSeatsRequest.ProtoReflect.Descriptor instead.
func (*UpdateFareSeatsRequest) Descriptor() ([]byte, []int) {
	return file_trip_proto_rawDescGZIP(), []int{14}
}

func (x *UpdateFareSeatsRequest) GetFareId() string {
	if x != nil {
		return x.FareId
	}
	return ""
...
func (x *UpdateFareSeatsRequest) GetSeats() int32 {
	if x != nil {
		return x.Seats
	}
	return 0
...
type UpdateFareSeatsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateFareSeatsResponse) Reset() {
	*x = UpdateFareSeatsResponse{}
	mi := &file_trip_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateFareSeatsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateFareSeatsResponse) ProtoMessage() {}

func (x *UpdateFareSeatsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_trip_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateFareSeatsResponse.ProtoReflect.Descriptor instead.
func (*UpdateFareSeatsResponse) Descriptor() ([]byte, []int) {
...
func (x *ListMyTripsRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
// Slim row for ride history (no full route geometry).
type RideHistoryEntry struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	TripId string                 `protobuf:"bytes,1,opt,name=trip_id,json=tripId,proto3" json:"trip_id,omitempty"`
	// "rider" if user booked the trip; "driver" if user accepted as driver.
	Role           string  `protobuf:"bytes,2,opt,name=role,proto3" json:"role,omitempty"`
	Status         string  `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`
	WhenRfc3339    string  `protobuf:"bytes,4,opt,name=when_rfc3339,json=whenRfc3339,proto3" json:"when_rfc3339,omitempty"`
	FareTotalCents float64 `protobuf:"fixed64,5,opt,name=fare_total_cents,json=fareTotalCents,proto3" json:"fare_total_cents,omitempty"`
	PackageSlug    string  `protobuf:"bytes,6,opt,name=package_slug,json=packageSlug,proto3" json:"package_slug,omitempty"`
	// e.g. driver name when role is rider; short label when role is driver.
	OtherPartyLabel string `protobuf:"bytes,7,opt,name=other_party_label,json=otherPartyLabel,proto3" json:"other_party_label,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *RideHistoryEntry) Reset() {
	*x = RideHistoryEntry{}
...
func (x *RideHistoryEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RideHistoryEntry) ProtoMessage() {}

func (x *RideHistoryEntry) ProtoReflect() protoreflect.Message {
	mi := &file_trip_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RideHistoryEntry.ProtoReflect.Descriptor instead.
func (*RideHistoryEntry) Descriptor() ([]byte, []int) {
	return file_trip_proto_rawDescGZIP(), []int{17}
}

func (x *RideHistoryEntry) GetTripId() string {
	if x != nil {
		return x.TripId
	}
	return ""
...
func (x *RideHistoryEntry) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *RideHistoryEntry) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *RideHistoryEntry) GetWhenRfc3339() string {
	if x != nil {
		return x.WhenRfc3339
	}
	return ""
}

func (x *RideHistoryEntry) GetFareTotalCents() float64 {
	if x != nil {
		return x.FareTotalCents
	}
	return 0
}

func (x *RideHistoryEntry) GetPackageSlug() string {
	if x != nil {
		return x.PackageSlug
	}
	return ""
...
func (x *RideHistoryEntry) GetOtherPartyLabel() string {
	if x != nil {
		return x.OtherPartyLabel
	}
	return ""
}
...
type ListMyTripsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Entries       []*RideHistoryEntry    `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListMyTripsResponse) GetEntries() []*RideHistoryEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
const file_trip_proto_rawDesc = "" +
	...
	"\atrip_id\x18\x01 \x01(\tR\x06tripId\"1\n" +
	"\x0fGetTripResponse\x12\x1e\n" +
	"\x04trip\x18\x01 \x01(\v2\n" +
	".trip.TripR\x04trip\"G\n" +
	"\x16UpdateFareSeatsRequest\x12\x17\n" +
	"\afare_id\x18\x01 \x01(\tR\x06fareId\x12\x14\n" +
	"\x05seats\x18\x02 \x01(\x05R\x05seats\"\x19\n" +
	"\x17UpdateFareSeatsResponse\"C\n" +
	"\x12ListMyTripsRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\"\xf3\x01\n" +
	"\x10RideHistoryEntry\x12\x17\n" +
	"\atrip_id\x18\x01 \x01(\tR\x06tripId\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x12!\n" +
	"\fwhen_rfc3339\x18\x04 \x01(\tR\vwhenRfc3339\x12(\n" +
	"\x10fare_total_cents\x18\x05 \x01(\x01R\x0efareTotalCents\x12!\n" +
	"\fpackage_slug\x18\x06 \x01(\tR\vpackageSlug\x12*\n" +
	"\x11other_party_label\x18\a \x01(\tR\x0fotherPartyLabel\"G\n" +
	"\x13ListMyTripsResponse\x120\n" +
	"\aentries\x18\x01 \x03(\v2\x16.trip.RideHistoryEntryR\aentries2\xb1\x03\n" +
	"\vTripService\x12B\n" +
	...
	"\x10IncreaseTripFare\x12\x1d.trip.IncreaseTripFareRequest\x1a\x1e.trip.IncreaseTripFareResponse\x126\n" +
	"\aGetTrip\x12\x14.trip.GetTripRequest\x1a\x15.trip.GetTripResponse\x12N\n" +
	"\x0fUpdateFareSeats\x12\x1c.trip.UpdateFareSeatsRequest\x1a\x1d.trip.UpdateFareSeatsResponse\x12B\n" +
	"\vListMyTrips\x12\x18.trip.ListMyTripsRequest\x1a\x19.trip.ListMyTripsResponseB\x18Z\x16shared/proto/trip;tripb\x06proto3"
...
var file_trip_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_trip_proto_goTypes = []any{
	...
	(*GetTripRequest)(nil),           // 12: trip.GetTripRequest
	(*GetTripResponse)(nil),          // 13: trip.GetTripResponse
	(*UpdateFareSeatsRequest)(nil),   // 14: trip.UpdateFareSeatsRequest
	(*UpdateFareSeatsResponse)(nil),  // 15: trip.UpdateFareSeatsResponse
	(*ListMyTripsRequest)(nil),       // 16: trip.ListMyTripsRequest
	(*RideHistoryEntry)(nil),         // 17: trip.RideHistoryEntry
	(*ListMyTripsResponse)(nil),      // 18: trip.ListMyTripsResponse
}
var file_trip_proto_depIdxs = []int32{
	...
	8,  // 11: trip.GetTripResponse.trip:type_name -> trip.Trip
	17, // 12: trip.ListMyTripsResponse.entries:type_name -> trip.RideHistoryEntry
	0,  // 13: trip.TripService.PreviewTrip:input_type -> trip.PreviewTripRequest
	6,  // 14: trip.TripService.CreateTrip:input_type -> trip.CreateTripRequest
	10, // 15: trip.TripService.IncreaseTripFare:input_type -> trip.IncreaseTripFareRequest
	12, // 16: trip.TripService.GetTrip:input_type -> trip.GetTripRequest
	14, // 17: trip.TripService.UpdateFareSeats:input_type -> trip.UpdateFareSeatsRequest
	16, // 18: trip.TripService.ListMyTrips:input_type -> trip.ListMyTripsRequest
	1,  // 19: trip.TripService.PreviewTrip:output_type -> trip.PreviewTripResponse
	7,  // 20: trip.TripService.CreateTrip:output_type -> trip.CreateTripResponse
	11, // 21: trip.TripService.IncreaseTripFare:output_type -> trip.IncreaseTripFareResponse
	13, // 22: trip.TripService.GetTrip:output_type -> trip.GetTripResponse
	15, // 23: trip.TripService.UpdateFareSeats:output_type -> trip.UpdateFareSeatsResponse
	18, // 24: trip.TripService.ListMyTrips:output_type -> trip.ListMyTripsResponse
