...
const file_trip_proto_rawDesc = "" +
	...
	"\x17UpdateFareSeatsResponse2\xed\x02\n" +
	"\vTripService\x12B\n" +
	...
	"\x0fUpdateFareSeats\x12\x1c.trip.UpdateFareSeatsRequest\x1a\x1d.trip.UpdateFareSeatsResponseB\x18Z\x16shared/proto/trip;tripb\x06proto3"
...
var file_trip_proto_depIdxs = []int32{
	...
	10, // 14: trip.TripService.IncreaseTripFare:input_type -> trip.IncreaseTripFareRequest
	12, // 15: trip.TripService.GetTrip:input_type -> trip.GetTripRequest
	14, // 16: trip.TripService.UpdateFareSeats:input_type -> trip.UpdateFareSeatsRequest
	1,  // 17: trip.TripService.PreviewTrip:output_type -> trip.PreviewTripResponse
	7,  // 18: trip.TripService.CreateTrip:output_type -> trip.CreateTripResponse
	11, // 19: trip.TripService.IncreaseTripFare:output_type -> trip.IncreaseTripFareResponse
	13, // 20: trip.TripService.GetTrip:output_type -> trip.GetTripResponse
	15, // 21: trip.TripService.UpdateFareSeats:output_type -> trip.UpdateFareSeatsResponse
