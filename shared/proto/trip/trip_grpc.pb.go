...
const (
	...
	TripService_IncreaseTripFare_FullMethodName = "/trip.TripService/IncreaseTripFare"
	TripService_GetTrip_FullMethodName          = "/trip.TripService/GetTrip"
	TripService_UpdateFareSeats_FullMethodName  = "/trip.TripService/UpdateFareSeats"
	TripService_ListMyTrips_FullMethodName      = "/trip.TripService/ListMyTrips"
)
...
type TripServiceClient interface {
	...
	UpdateFareSeats(ctx context.Context, in *UpdateFareSeatsRequest, opts ...grpc.CallOption) (*UpdateFareSeatsResponse, error)
...
func (c *tripServiceClient) IncreaseTripFare(ctx context.Context, in *IncreaseTripFareRequest, opts ...grpc.CallOption) (*IncreaseTripFareResponse, error) {
	...
	err := c.cc.Invoke(ctx, TripService_IncreaseTripFare_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tripServiceClient) UpdateFareSeats(ctx context.Context, in *UpdateFareSeatsRequest, opts ...grpc.CallOption) (*UpdateFareSeatsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateFareSeatsResponse)
	err := c.cc.Invoke(ctx, TripService_UpdateFareSeats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tripServiceClient) ListMyTrips(ctx context.Context, in *ListMyTripsRequest, opts ...grpc.CallOption) (*ListMyTripsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListMyTripsResponse)
	err := c.cc.Invoke(ctx, TripService_ListMyTrips_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TripServiceServer interface {
	...
	UpdateFareSeats(context.Context, *UpdateFareSeatsRequest) (*UpdateFareSeatsResponse, error)
...
func (UnimplementedTripServiceServer) IncreaseTripFare(context.Context, *IncreaseTripFareRequest) (*IncreaseTripFareResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IncreaseTripFare not implemented")
}
...
func (UnimplementedTripServiceServer) UpdateFareSeats(context.Context, *UpdateFareSeatsRequest) (*UpdateFareSeatsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateFareSeats not implemented")
}
func (UnimplementedTripServiceServer) ListMyTrips(context.Context, *ListMyTripsRequest) (*ListMyTripsResponse, error) {
...
func _TripService_IncreaseTripFare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TripService_IncreaseTripFare_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TripService_UpdateFareSeats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateFareSeatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TripServiceServer).UpdateFareSeats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TripService_UpdateFareSeats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TripServiceServer).UpdateFareSeats(ctx, req.(*UpdateFareSeatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TripService_ListMyTrips_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListMyTripsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TripServiceServer).ListMyTrips(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TripService_ListMyTrips_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TripServiceServer).ListMyTrips(ctx, req.(*ListMyTripsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TripService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateFareSeats",
			Handler:    _TripService_UpdateFareSeats_Handler,
		},
		{
			MethodName: "ListMyTrips",
			Handler:    _TripService_ListMyTrips_Handler,
		},
	},
