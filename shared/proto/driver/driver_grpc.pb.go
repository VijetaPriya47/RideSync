...
const (
	...
	DriverService_NotifyTripAccepted_FullMethodName  = "/driver.DriverService/NotifyTripAccepted"
	DriverService_NotifyTripCompleted_FullMethodName = "/driver.DriverService/NotifyTripCompleted"
)
...
func (c *driverServiceClient) NotifyTripAccepted(ctx context.Context, in *NotifyTripAcceptedRequest, opts ...grpc.CallOption) (*NotifyTripAcceptedResponse, error) {
	...
	err := c.cc.Invoke(ctx, DriverService_NotifyTripAccepted_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *driverServiceClient) NotifyTripCompleted(ctx context.Context, in *NotifyTripCompletedRequest, opts ...grpc.CallOption) (*NotifyTripCompletedResponse, error) {
	...
	err := c.cc.Invoke(ctx, DriverService_NotifyTripCompleted_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DriverService_NotifyTripAccepted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DriverService_NotifyTripAccepted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DriverService_NotifyTripCompleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DriverService_NotifyTripCompleted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
