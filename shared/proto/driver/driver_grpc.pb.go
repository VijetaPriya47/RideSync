...
func (UnimplementedDriverServiceServer) NotifyTripAccepted(context.Context, *NotifyTripAcceptedRequest) (*NotifyTripAcceptedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NotifyTripAccepted not implemented")
}
func (UnimplementedDriverServiceServer) NotifyTripCompleted(context.Context, *NotifyTripCompletedRequest) (*NotifyTripCompletedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NotifyTripCompleted not implemented")
}
